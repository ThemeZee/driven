					...
					<div class="wp-block-group alignfull has-white-background-color has-background" style="padding-top:3.5vw;padding-right:3.5vw;padding-bottom:3.5vw;padding-left:3.5vw">
						...
						<div class="wp-block-columns alignwide are-vertically-aligned-center" style="margin-bottom:0px">
							...
							<div class="wp-block-column is-vertically-aligned-center">
								...
								<h1 class="is-style-underlined-heading" style="margin-top:0px">' . __( 'Pursue your passion <br>All dreams can come true', 'driven' ) . '</h1>
								<!-- /wp:heading -->
								...
								<div class="wp-block-buttons is-style-default">
									...
									<!-- wp:button -->
									<div class="wp-block-button"><a class="wp-block-button__link">' . __( 'Start now', 'driven' ) . '</a></div>
									<!-- /wp:button -->

									<!-- wp:button -->
									<div class="wp-block-button"><a class="wp-block-button__link">' . __( 'Learn more', 'driven' ) . '</a></div>
									<!-- /wp:button -->
